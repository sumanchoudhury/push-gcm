...
var initialize = _.once(function () {
    ...
    // I must ensure uniqueness across the two properties because two users can have the same token (ex: in apn, 1 token === 1 device)
...
var add = function (user, deviceType, token) {
    console.log({user: user, type: deviceType, token: token});
